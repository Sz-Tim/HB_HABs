...
mod_cols <- c(grand="black", fourWk="grey40", 
              glm="grey60", glm_split="grey60", glmLasso="grey80",
              bern="dodgerblue", bernP="dodgerblue", 
              MVbern="dodgerblue", MVbernP="dodgerblue",
              ord="cadetblue", ordP="cadetblue", 
              MVord="cadetblue", MVordP="cadetblue", 
...
mod.i <- tibble(mod_col=names(mod_cols),
                mod_clean=c("Grand mean", "4-week mean", 
                            paste0("GLM-", 1:3),
                            paste0("Logistic-", 1:2),
                            paste0("Logistic-MV-", 1:2),
                            paste0("Ordinal-", 1:2),
                            paste0("Ordinal-MV-", 1:2),
                            "RF-1", "RF-2",
                            "SVM-1", "SVM-2",
                            "XGB-1", "XGB-2",
                ...
                mod_short=c("Mean", "4-wk", 
                            "GLM-1", "GLM-2", "GLM-3",
                            "L-1", "L-2", "L-MV-1", "L-MV-2",
                            "O-1", "O-2", "O-MV-1", "O-MV-2",
                            "RF-1", "RF-2", 
                            "SVM-1", "SVM-2", 
                            "XGB-1", "XGB-2",
